...
import { datePickerCacheGet, datePickerCachePut } from "./cache.js";
...
export default class DatePickerWidget {
    ...
    */
    ...
    constructor(view, widget, model) {
        ...
        this.#model = model;
        this.#lang = model.lang === undefined ?  model.lang : "en";
        let editValFn = (value) => {
        ...
        this.#widget = getWidget(view.element);
        this.#attachField(getWidget(view.element), this.#options);
    }
    ...
    #attachField(widget, options) {
        ...
        datePickerCachePut(widget,"datetimepicker",inst);
    ...
    insertRow (rowNum, rowArray, isHeader, elementAt) {
       ...
       rowArray.forEach(function(el,index) {
            ...
            if(isHeader)
                ...
                datePickerCachePut($li, "value", element.data);
    ...
    #activateField(evnt) {
        let self = this;
        this.#curInstance = datePickerCacheGet(evnt.target,"datetimepicker");
        // Issue LC-7049:
    ...
    #selectDate(evnt) {
        let val = datePickerCacheGet(evnt.target, "value"),
    ...
    addEventListener(event, handler, widget) {
        let inst = datePickerCacheGet(widget, "datetimepicker");
